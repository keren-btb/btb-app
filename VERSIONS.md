...
## pos.html
- v1.6.1 — 2026-08-17 — "Use voucher" checkout panel: added live search by buyer or recipient name (not just exact code) — type 2+ characters and matching active vouchers appear below (code, value, who it's for/from), tap one to apply it directly.
